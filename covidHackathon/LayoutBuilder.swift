...
public class LayoutBuilder {
    ...
    public static func buildGallerySectionLayout(size: NSCollectionLayoutSize, itemInset:NSDirectionalEdgeInsets = NSDirectionalEdgeInsets(top: 0.0, leading: 12.0, bottom: 0.0, trailing: 12.0), sectionInset: NSDirectionalEdgeInsets = NSDirectionalEdgeInsets(top: 16.0, leading: 0.0, bottom: 90.0, trailing: 0.0)) -> NSCollectionLayoutSection {
    ...
    public static func buildTableSectionLayout() -> NSCollectionLayoutSection {
        let item = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .fractionalHeight(1.25)))
